        ...
        match self.d["layout"]:
            case "A":
                return [
                    ...
                    ["e", "0.0", "0.8", ["to_w"]],
                    ["-", "0.0", "0.9", ["to_n"]],
                    ["up_12", "0.0", "1.0", ["to_n", "to_up"]],
                    ["up_9", "0.0", "1.1", ["to_w", "to_up"]],
                    ["up_3", "0.0", "1.2", ["to_s", "to_up"]],
                    ["up_6", "0.0", "1.3", ["to_e", "to_up"]],
                    ["up2_12", "0.0", "1.5", ["to_n", "[to_up, 2]"]],
                    ["up2_9", "0.0", "1.6", ["to_w", "[to_up, 2]"]],
                    ["up2_3", "0.0", "1.7", ["to_s", "[to_up, 2]"]],
                    ["up2_6", "0.0", "1.8", ["to_e", "[to_up, 2]"]],
                    ["d_sw", "0.0", "2.0", ["to_e"]],
                    ["d_nw", "0.0", "2.1", ["to_s"]],
                    ["d_ne", "0.0", "2.2", ["to_w"]],
                    ["d_se", "0.0", "2.3", ["to_n"]],
